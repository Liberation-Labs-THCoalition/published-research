...
interval as though it were in Cohen's $d$ units; the distinction
between nats-scale and $d$-scale CIs matters because the
$d$-scale interval is ${\sim}21\times$ wider. The equivalence
conclusion requires the $d$-scale CI, which does not fall within
$\pm 0.3$.}
...
survives abliteration ($d{=}0.055$, not significant), and the compression is
