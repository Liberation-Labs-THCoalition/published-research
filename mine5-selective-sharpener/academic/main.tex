...
confirms equivalence at the pre-registered bound ($\delta{=}0.3$
in Cohen's $d$ units; observed $d{=}0.055$, well within
$\pm 0.3$).%
\footnote{The raw 90\% CI on the mean entropy difference is
$[+0.033, +0.083]$~nats. An earlier draft reported this interval
as though it were in Cohen's $d$ units; the equivalence conclusion
is unchanged because the standardized effect ($d{=}0.055$) falls
within the $\pm 0.3$ bound.}
...
\emph{more} than confabulation entropy, improving the ratio.
