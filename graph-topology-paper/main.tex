...
\textbf{Keyword scoring.} The scoring method may undercount correct responses phrased differently or overcount responses that mention keywords without correct reasoning.

\textbf{Sample size.} Six to seven queries per condition is small. Larger query sets with statistical significance testing are needed for definitive claims.
