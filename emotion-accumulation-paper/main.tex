...
\emph{uncertainty scar} (Hedges $g{=}+7.89$; uncorrected $d{=}+9.86$;
...
hostile} than pure hostile (Hedges $g{=}+2.39$; uncorrected $d{=}+2.99$,
...
cheerful in \emph{valence} (Hedges $g{=}-1.58$; uncorrected $d{=}-1.97$,
$p{=}0.12$)---the emotional
tone recovers. But it retains significantly elevated \emph{uncertainty}
(Hedges $g{=}+7.89$; uncorrected $d{=}+9.86$, $p{<}0.001$). The neutral gap
left a scar in the
...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Small N per cell.} 3~reps per condition; dynamics
          effects (whiplash $g{=}-2.35$, echo $g{=}+7.89$) are large but
    ...
    \item \textbf{Uncorrected effect sizes.} Most $d$ values are
          ...
          $d{=}9.86$ corrects to $g{\approx}7.9$, and the contrast
