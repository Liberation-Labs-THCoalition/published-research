...
Entity deconfounding is in progress. Encoding-phase stable rank at L15 is
...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Entity recognition confound (major).} Token counts are
          ...
          answer to this question.'' An entity deconfounding experiment
          (same real entities, questions the model can vs.\ cannot answer)
          is required to distinguish these interpretations. Until that
          experiment is complete, the encoding AUROC should be interpreted
          as entity recognition pending deconfounding.
...
token-matched prompts. However, an entity recognition confound
complicates interpretation: the classifier may be detecting entity
familiarity (common vs.\ rare tokens) rather than epistemic state.
Entity deconfounding---using questions the model can and cannot answer
about the \emph{same} real entities---is needed to resolve this
ambiguity.
