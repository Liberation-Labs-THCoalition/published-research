...
This phenomenon has been independently identified by
\citet{simhi2025trust} as CHOKE (Certain Hallucinations Overriding Known
Evidence) and theoretically grounded by \citet{kalai2024calibrated}, who
prove that calibrated language models \emph{must} hallucinate at rates
determined by training data frequency. Our contribution is the geometric
and temporal characterization: the paradox manifests in KV-cache spectral
features (not just output logits), peaks in early content generation,
and fades as the response develops.
