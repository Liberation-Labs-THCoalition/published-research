...
knowledge. The $7\%$ that slip through are the cases the Oracle Loop
...
${\sim}7\%$. The remaining responses split between self-referential
...
\begin{tabular}{lrrr}
\toprule
Method & HEDGED & CONFAB & Confab rate \\
\midrule
Regex (self-referential only) & 12 & 33 & 73\% \\
Regex (+ declarative markers) & 19 & 26 & 58\% \\
