...
\begin{enumerate}[nosep]
    ...
    \item \textbf{LLM-judge reliability (and why geometry is more
          ...
          original CONFABULATED labels (6/7). Across methods the true
          rate sits in the 8--16\% range; the ``73\%'' regex figure is a
          definitive artifact. Crucially, the geometric detector
          (AUROC~0.93) is more reproducible than any behavioral label:
          it reads the model's epistemic state directly, sidestepping
          the judge-reliability problem entirely. Human validation
