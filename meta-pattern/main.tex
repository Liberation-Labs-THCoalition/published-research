...
The body count is 7 confirmed, 7 suspected, and 10 honestly
falsified.\footnote{\textbf{Correction (2026-08-14).} The published
version of this paper reported 25 experiments and a body count of
...
(\citealt{lyra2026weather}, \S Correction note) on 2026-05-21, 57 days
...
quality). The split is 7-for-7 on metacognition, 0-for-10 on content.
...
paper documents the pattern, reports the full body count (7 confirmed,
...
\midrule
\multicolumn{4}{l}{\textit{Confirmed (7) --- all metacognitive state}} \\
\addlinespace
...
source on 2026-05-21 as an FWL-before-CV leakage artifact; within-fold
...
binary valence at AUROC~$0.992$~\citep{lyra2026weather}. We flag
...
The 7/7--0/10 split should therefore be treated as
...
$8/8$--$0/10$, and one of those eight was a retracted result whose
...
The 7/10 split is a guide for future work: if you are building a
...
was known, and the 7/7--0/10 split is the outcome the taxonomy was built
...
Twenty-four experiments. Seven confirmed, seven suspected, ten killed.
