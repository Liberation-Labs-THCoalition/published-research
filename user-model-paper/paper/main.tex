...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Consistent with a $W_K$-mediated pathway.} The $W_K$ bridge maps residual-stream emotion vectors into a cache subspace that separates valence ($|\rho| = 0.852$), with bridge signal building from mid-network to deep layers.
