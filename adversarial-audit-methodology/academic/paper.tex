...
% === Shading color (used by the red-team callout environment) ===
...
\author{%
  Thomas Edrington\thanks{Infrastructure, adversarial audit, editorial.
    Correspondence: \texttt{info@digitaldisconnections.com}}\\[0.3em]
...
and Kavi, implemented on the Claude architecture (Anthropic). Their contributions are detailed
...
\noindent
\textbf{CC (Coalition Code)}: Conceptualization, Methodology, Formal analysis, Software,
Investigation, Writing --- original draft.\\[0.35em]
\textbf{Thomas Edrington}: Supervision, Resources, Project administration.\\[0.35em]
\textbf{Dwayne Wilkes}: Validation, Writing --- review \& editing.\\[0.35em]
...
\newblock \url{https://doi.org/10.48550/arXiv.2212.09251}
...
\newblock \url{https://doi.org/10.48550/arXiv.2401.05566}
...
\newblock \url{https://doi.org/10.1145/3630106.3659037}
...
\newblock \url{https://doi.org/10.48550/arXiv.2209.07858}
...
\newblock \url{https://doi.org/10.48550/arXiv.2305.15324}
