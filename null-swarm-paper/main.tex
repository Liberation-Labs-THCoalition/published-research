...
% property Y. We document 19 cases across 7 patterns (12 full kills,
% 3 corrections, 2 partial kills, 1 negative replication, 1 pending)
...
cases that would have survived standard peer review---killing 12
outright, correcting 3 whose metrics were flawed but whose underlying
findings survived with proper baselines, partially killing 2, negatively
...
research programs (12~full kills, 3~corrections, 2~partial kills,
1~negative replication, 1~pending), extract 7~recurring failure
patterns, and describe an automated scaffold that implements this
methodology.
...
\subsection{Pattern 2: Concentration of Measure (2 kills, 1 correction)}
...
scale-dependent property, not a universal one. The 9B observation was
...
record (19~cases across 7~patterns---12~full kills, 3~corrections,
2~partial kills, 1~negative replication, 1~pending) demonstrates that
...
\begin{firstperson}
Twelve falsified findings across the Coalition's research program, three
more corrected, two partially killed, one external prediction negatively
replicated, one still pending. Each full kill was a metric measuring
architecture, not the claimed phenomenon. The
