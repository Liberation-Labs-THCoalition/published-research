...
\emph{Source note:} The original source for this prediction could not be
verified; a previously cited paper (arXiv:2205.12510, Liu \& Ueda,
``Exact Phase Transitions in Deep Learning'') addresses loss-landscape
phase transitions and does not discuss SVD norms.
\emph{Negative replication:} Lyra tested directly. Negative result. The
prediction does not hold for trained models.
