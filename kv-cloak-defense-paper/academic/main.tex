...
classifiers were not tested under obfuscation. A within-model deception
AUROC of $1.000$ was previously cited here; it has been withdrawn~\citep{lyra2026techniqueii}
(prompt-template confound; the same-prompt control falls to $0.160$),
so no prior-work detection ceiling is asserted.
\end{enumerate}
