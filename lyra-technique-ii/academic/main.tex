...
within-model deception at AUROC~1.000, confabulation at 0.663--0.913 across a
15-model scale sweep, and the persona-intensity endpoint (L0 vs.\ L3) at raw
AUROC~0.749. We tested whether SVD denoising (within-fold rank-$k$ projection
...
spectral shape reads cognitive mode (within-model deception 1.000,
confabulation 0.66--0.91). The Lyra Technique is a toolkit---a compass and a
