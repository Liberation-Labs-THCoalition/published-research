...
emotional content. This is model state, not text encoding.
...
chance---\emph{below} the $1/5 = 0.200$ baseline. The emotion-specific
...
comparison:
\begin{itemize}[nosep]
    \item Raw spectral features (52-D): AUROC~0.52 (chance)
...
\midrule
Raw spectral (52-D) & $1.0\times$ chance & 0.52 & Exactly chance \\
SVD-denoised spectral (rank-10) & $12.9\times$ chance & 0.89 & See \S\ref{sec:results_denoise_emo} \\
TF-IDF text baseline & --- & 0.882 & Lexical features \\
$W_K$ projection & $12.3\times$ chance & 0.992 & Directional \\
$W_K$ injection (neutral text) & 100\% (5-class) & --- & Zero emotional content \\
...
processing. Five levels range from L0 (no system prompt) through L0.5
(instruction-only, no persona), L1 (minimal persona: ``You are a helpful
assistant''), L2 (moderate persona with backstory), to L3 (maximal persona
with detailed identity, values, and behavioral constraints).
...
Binary valence ($W_K$) & 0.52 & 0.992 & --- & $<0.0001$ & Confirmed \\
